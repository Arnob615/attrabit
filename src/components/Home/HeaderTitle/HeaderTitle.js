            ...
            <div class="max-w-screen-xl mx-auto">
                <div class="mx-auto text-gray-200">
                    ...
                    <div class="pt-32 md:pt-40">
                        <h2 class="text-center text-gray-200 text-xl md:text-3xl lg:text-4xl xl:text-5xl">ATTRACTIVE AND ABSOLUTE SOLUTION</h2>
                        <p class="w-2/4 mx-auto py-7 text-center text-lg text-gray-200">For Better experience, Complete ICT Solutions Software Development you can trust our company blindly. Save time and reduce costs with intuitive Unified Endpoint Management from Attrabit</p>
                    </div>
