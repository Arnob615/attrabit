                ...
                <div class="p-3">
                    {/* Business Consultancy Content start */}
                        <div>
                            ...
                            <Fade bottom duration={1000}>
                                <div>
                                    <p class="text-gray-400 text-justify first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-sky-500 first-letter:mr-3 first-letter:float-left">Our consortium of seasoned consultants positions itself as a dynamic and client-centric consultancy firm in the Offshore Business Development, Network Services and Solutions, ICT Solutions, Software Development, including a broad outsourcing portfolio in the IT industry.</p>
                    ...
                    <div class="grid md:grid-cols-2 gap-6 pt-20 items-center" id="fdi-market">
                        <Fade bottom duration={1000}>
                            <div>
                                ...
                                <p class="text-gray-400 text-justify first-line:uppercase first-line:tracking-widest first-letter:text-5xl first-letter:font-bold first-letter:text-sky-500 first-letter:mr-3 first-letter:float-left">Analysing your business, the Key to success! Attrabit uses a combination of enhanced secondary research techniques (analysis of customer/industry/stakeholder/competitor etc.) and structured primary research methodologies (for reliable data efficiency) in our approach to research tools.</p>
                                ...
                                <p class="text-gray-400 text-justify text-base">So let’s put our heads together. We’ll bring our insight to your business and help you grow.</p>
                            </div>
                        </Fade>
                        ...
                        <Fade bottom duration={1000}>
                            <div>
                                ...
                                <div class="mt-12 px-10">
                                    <p class="text-gray-400 text-justify first-line:uppercase first-line:tracking-widest first-letter:text-5xl first-letter:font-bold first-letter:text-sky-500 first-letter:mr-3 first-letter:float-left">Attrabit will support you to establish and explore your business to overseas.</p>
                                    <p class="text-gray-400 text-justify py-2 text-base">We will help you to start the business in terms of provide corporate information, introduction, coordination, sales activities, production management, and provide information on material procurement as well.</p>
                                    <p class="text-gray-400 text-justify py-2 text-base">We also provide the support for incorporation, Company establishment, Registration and Rental office.</p>
                                    <p class="text-gray-400 text-justify py-2 text-base">For expatriates we provide and introduce housing, public safety, health care, education, daily life and information support.</p>
                                </div>
                            </div>
                        </Fade>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6 pt-20 items-center" id="operation-management">
                        <Fade bottom duration={1000}>
                            <div>
                                ...
                                <p class="text-gray-400 text-center md:text-left pt-8 first-line:uppercase first-line:tracking-widest first-letter:text-5xl first-letter:font-bold first-letter:text-sky-500 first-letter:mr-3 first-letter:float-left">Attrabit is the specialist in operation management support in south asian region.</p>
                                ...
                                <ul class="text-gray-400 text-justify py-2 text-base">
                                    ...
                                    <li>– Prepare roadmap to overcome the business problem and attain the business goals</li>
                                    <li>– Provide management knowledge to achieve the roadmap</li>
                                    <li>– Provide ICT solutions to improve and maximize the management capability.</li>
                                </ul>
                            </div>
                        </Fade>
