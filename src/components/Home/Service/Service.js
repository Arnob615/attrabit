            ...
            <div class="max-w-screen-xl mx-auto">
                ...
                <div class="grid grid-cols-3 p-3">
                    <div>
                        ...
                        <button onClick={handleNetworkSolution} class="bg-blue-900 text-white px-3 py-1 transform duration-300 hover:bg-yellow-400 hover:text-gray-900">Read Details...</button>
                    </div>
                    ...
                    <div>
                        ...
                        <button onClick={handleSoftwareDevelopment} class="bg-blue-900 text-white px-3 py-1 transform duration-300 hover:bg-yellow-400 hover:text-blue-900 hover:text-gray-900">Read Details...</button>
                    </div>
                    ...
                    <div>
                        ...
                        <button onClick={handleIctSolution} class="bg-blue-900 text-white px-3 py-1 transform duration-300 hover:bg-yellow-400 hover:text-blue-900 hover:text-gray-900">Read Details...</button>
                    </div>
                </div>
            </div>
        </section>
