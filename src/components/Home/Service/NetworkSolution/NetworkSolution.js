                        ...
                        <Fade bottom duration={1000}>
                            <div class="py-20">
                                ...
                                <div class="mt-12 px-10">
                                    <p class="text-gray-400 text-justify first-line:uppercase first-line:tracking-widest first-letter:text-5xl first-letter:font-bold first-letter:text-sky-500 first-letter:mr-3 first-letter:float-left">Our Voice & Video solutions help you communicate and collaborate within and beyond your organization, helping you meet the demands of growth.</p>
                    ...
                    <div class="grid md:grid-cols-2 gap-6 pt-20 items-center" id="network-security">
                        <Fade bottom duration={1000}>
                            <div>
                                ...
                                <p class="text-gray-400 text-justify pt-8 first-line:uppercase first-line:tracking-widest first-letter:text-5xl first-letter:font-bold first-letter:text-sky-500 first-letter:mr-3 first-letter:float-left">If you are like most businesses today, you share data with customers, partners and suppliers almost constantly. While this ability to communicate and collaborate makes your business more productive, it also makes your business’s security and compliance vitally important. What steps are you taking to ensure your company’s data is being protected in the most aggressive ways possible?</p>
