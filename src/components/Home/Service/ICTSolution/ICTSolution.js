                    ...
                    <div class="grid lg:grid-cols-2 gap-6 my-0 md:pt-20 mx-auto items-center" id="db-management">
                        ...
                        <Fade bottom duration={1000}>
                            <div class="">
                                ...
                                <div class="p-10">
                                    <p class="text-gray-400 text-justify first-line:uppercase first-line:tracking-widest first-letter:text-5xl first-letter:font-bold first-letter:text-sky-500 first-letter:mr-3 first-letter:float-left">Comprehensive Database Consulting Services.</p>
