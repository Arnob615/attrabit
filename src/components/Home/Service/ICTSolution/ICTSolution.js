            ...
            <div class="max-w-screen-xl mx-auto">
                ...
                <div class="content_wrapper p-3">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 my-10 items-center">
                        ...
                        <Fade bottom duration={1000}>
                            <div class="mx-10">
                                <h2 class="text-3xl my-10 text-gray-100">DB-MANAGEMENT</h2>
                                <div>
                                    <p class="text-gray-300 text-justify text-base">Comprehensive Database Consulting Services.</p>
                                    <p class="text-gray-300 text-justify py-2 text-base">Do you want your organization to be as efficient and effective as possible? Of course you do! You can help your organization reach new levels in performance with Attrabit database consulting services. Our services will show you how to foster a more effective, more reliable database environment, which will lead to a stronger, more successful organization or enterprise overall. With the help of a proven database consultancy like Attrabit, you can properly manage and utilize your data to provide you with the type of business intelligence the world’s most successful corporations leverage to guide their own operations. And we would know, since we’ve worked with them ourselves.</p>
                                </div>
                            </div>
                        </Fade>
                    </div>
