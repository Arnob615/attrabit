            ...
            <div class="max-w-screen-xl mx-auto">
                <div class="content_wrapper p-3">
                    ...
                    <div class="grid grid-cols-2 gap-6 my-10">
                        ...
                        <div class="mx-10">
                            <h2 class="text-3xl my-10 px-10 text-gray-900">DB-Management</h2>
                            <div>
                                <p class="text-gray-700 text-justify">Comprehensive Database Consulting Services.</p>
                                <p class="text-gray-700 text-justify py-2">Do you want your organization to be as efficient and effective as possible? Of course you do! You can help your organization reach new levels in performance with Indo Tech database consulting services. Our services will show you how to foster a more effective, more reliable database environment, which will lead to a stronger, more successful organization or enterprise overall. With the help of a proven database consultancy like Indo Tech , you can properly manage and utilize your data to provide you with the type of business intelligence the world’s most successful corporations leverage to guide their own operations. And we would know, since we’ve worked with them ourselves.</p>
                            </div>
                        </div>
                    </div>
