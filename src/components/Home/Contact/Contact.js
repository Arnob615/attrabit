    ...
    return (
        <section class="p-10">
            <div class="max-w-screen-xl mx-auto rounded-3xl transform duration-300 bg-sky-900 hover:bg-sky-800">
                <h1 class="text-4xl pt-16 mb-10 p-4 text-gray-200 text-center">CONTACT US</h1>
                <div class="grid lg:grid-cols-2 justify-between gap-4 md:p-5 lg:p-5">
                        ...
                        <form onSubmit={sendEmail}>
                            <div className="row pt-5 p-2">
                                <div className="input-form">
                                    <label className="text-gray-200 pr-20">Full Name</label>
                                ...
                                <div className="text-area mt-5">
                                    ...
                                    <textarea className="form-control w-96 lg:w-full p-3" id="" rows="7" placeholder="Your Message" name="Message" required></textarea>
                                </div>
                    ...
                    <Zoom bottom duration={1000}>
                        <div className="px-6 lg:px-40 mx-auto">
                            <h3 className="text-2xl md:text-2xl xl:text-3xl my-5 pb-4 text-gray-200">GET IN TOUCH</h3>
