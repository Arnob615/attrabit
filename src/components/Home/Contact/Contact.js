            ...
            <div class="max-w-screen-xl mx-auto">
                ...
                <div class="grid lg:grid-cols-2 mt-10 gap-4 md:p-5 lg:p-5 items-center bg-sky-800 rounded-3xl">
                    ...
                    <Slide left duration={1000}>
                        <form class="p-10" onSubmit={sendEmail} >
                            <div className="p-12 mx-auto bg-gray-800 rounded-3xl">
                                ...
                                <div className="mt-4 text-center">
                                    <input type="submit" class="submit-button transform duration-300 text-lg bg-sky-600 hover:bg-sky-700 hover:text-white hover:translate-x-4 text-gray-200 w-full h-12 cursor-pointer" value="Send Message"/>
                                </div>
                            </div>
                        </form>
                    </Slide>
                    ...
                    <Slide right duration={1000}>
                        <div className="mx-auto text-center ">
                            ...
                            <div className="address mt-10 text-gray-300">
                                <FontAwesomeIcon class="w-8 pb-2 text-red-600 cursor-pointer duration-300 ml-24" icon={faPeriscope}></FontAwesomeIcon>
                                <h4>Address</h4>
                                <p>Baridhara, Dhaka Bangladesh</p>
                            </div>
                            <div className="email my-10 text-gray-300">
                                <FontAwesomeIcon class="w-8 pb-2 text-red-600 cursor-pointer duration-300 ml-24" icon={faAppStore}></FontAwesomeIcon>
                                <h4>Email</h4>
                                <p>info@attrabit.net</p>
                            </div>
                            <div className="phone my-4 text-gray-300">
                                <FontAwesomeIcon class="w-7 pb-2 text-red-600 cursor-pointer duration-300 ml-24" icon={faAddressBook}></FontAwesomeIcon>
                                <h4>Phone</h4>
                                <p>+8801671060576</p>
                            </div>
                        </div>
