  ...
  return (
    <main class="bg-gray-200">
      <Router>
        {/* Nav link start*/}
        <div class="py-8">
          <nav class="fixed inset-x-0 top-0 z-50 bg-gray-800">
            <div class="max-w-screen-xl mx-auto flex justify-between p-3 items-center h-16">
              <div class="flex">
                ...
                {/* Navbar is here */}
                <div class= "hidden lg:flex text-gray-200 space-x-5 ml-14 items-center lg:text-sm xl:text-base">
                  <Link class=" transform duration-300 bg-yellow-600 px-4 py-1 hover:bg-yellow-800" to="/">
              ...
              <div class="hidden lg:flex space-x-3 items-center">
                ...
                <Link class="text-lg bg-gray-500 px-4 text-white py-1 transform duration-300 hover:bg-gray-600" to="">Signup</Link>
              </div>
